...
import { saveQ2 } from '../redux/reducers/question'
import { userRequest } from '../axios'

const Question2 = ({ save }) => {
    ...
    const [data, setData] = useState(q.Q2.data?q.Q2.data:{
        a11: null,
        a12: null,
        a13: null,
        a21: null,
    ...
    useEffect(() => {
        if (save) {
            ...
            if (!res) {
                dispatch(saveQ2({ data: data, save: true }))
                sendData({ data: data, save: true })
            } else {
                dispatch(saveQ2({ data: data, save: false }))
