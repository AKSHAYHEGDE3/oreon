...
import {saveQ3} from '../redux/reducers/question'
import { userRequest } from '../axios'

const Question3 = ({save}) => {
    ...
    const [data,setData] = useState(q.Q3.data?q.Q3.data:{
        a11: null,
        a12: null,
        a13: null,
        a21: null,
    ...
    useEffect(()=>{
        ...
        if(!res){
            dispatch(saveQ3({data:data,save:true}))
            sendData({ data: data, save: true })
        }else{
            dispatch(saveQ3({data:data,save:false}))
